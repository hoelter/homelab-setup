...
* 2 * * * /home/chris/setup-scripts/host/restic-backup.sh >> /var/log/restic-backup.log 2>&1
...
* 1 * * * /home/chris/setup-scripts/host/update-nextdns-profile.sh >> /var/log/update-nextdns-profile.log 2>&1
EOF
